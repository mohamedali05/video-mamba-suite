...
class PtTransformer(nn.Module):
    ...
    def forward(self, video_list):
        ...
        for i, feat in enumerate(feats):
            print(f'Feature {i + 1} shape after backbone: {feat.shape}')
        '''

        '''
            for i, mask in enumerate(masks):
                print(f'Feature {i + 1} shape after backbone: {mask.shape}')
        '''
        ...
        for i, feat in enumerate(fpn_feats):
            print(f'fpn feats  {i + 1} shape {feat.shape}')
            print(feat)
        '''
        ...
        for i, point in enumerate(points):
            print(f' point {i + 1} shape {point.shape}')
            print(point)
        '''
        ...
        '''
        for i, out_cls_logit in enumerate(out_cls_logits):
            print(f' out_cls_logit {i + 1} shape {out_cls_logit.shape}')
            #print(out_cls_logit)
        '''

        '''
        for i, out_offset in enumerate(out_offsets):
            print(f' out_offset {i + 1} shape {out_offset.shape}')
            #print(out_offset)
        '''
